...
- Thread on the second M8 Hex Nut --- this will go on from the bottom, ensuring that all the threads are in good shape --- tighten the two nuts against the bearing so that the flexible coupler won't be load-bearing
