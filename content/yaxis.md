...
Attach one end plate (**\#1**) to one piece of MakerSlide, with the lip facing right using the 12mm M5 bolts (**\#2**) and M5 washers (**\#3**). Attach another end plate (**\#1**) to other piece of MakerSlide, with the lip facing left. 
