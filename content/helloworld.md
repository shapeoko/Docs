...
**Note: There has been one report of difficulty with the Z-axis caused by the $5=2500 setting --- if your Z-axis doesn't move reliably (please test it thoroughly before running a cutting job), try the original smaller value $5=500, or for troubleshooting, reduce it to 250.**
